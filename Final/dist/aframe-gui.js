...
// Look the TAG "**** Changed by APM" for the customizations
...
AFRAME.registerComponent('gui-interactable', {
    ...
    init: function init() {
        ...
        if (data.keyCode) {
            ...
            }, false); // **** Changed by APM: from true to false
        }
    },
    update: function update() {},
    tick: function tick() {},
...
AFRAME.registerComponent('gui-label', {
  schema: {
    text: { type: 'string', default: '' }, // **** Changed by APM from 'text label' to ''
